...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/05/07 12:30:39 by honlee            #+#    #+#             */
/*   Updated: 2021/05/07 12:34:15 by honlee           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "get_next_line.hpp"

unsigned int	ft_get_cnt(char *str, const char *charset)
{
	unsigned int	idx;
	unsigned int	ret;
...
int				ft_is_sep(char c, const char *charset)
{
	int idx;
